...
class PHPWebSocket
{
	...
	public $wsClientFileCount = array();
	...
	/*
		...
		$wsClientFileCount [filename] = integer ClientCount   // amount of clients connected per filename
	*/
	...
	function wsSendClientMessage($clientID, $opcode, $message) {
		...
		// check if client has set up the filename for which the connection was opened here
